...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Spot Finder">
    <meta name="keywords" content="Spot Finder">
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> spotfinder@doctum.com</li>
                <li>Spot Finder</li>
            </ul>
        </div>
    </div>
                        ...
                        <ul>
                            @foreach($categorias as $categoria)
                                @if(!is_numeric($categoria->Categoria))
                                    <li>
                                        <a href="{{ route('produtos.categoria', ['nomeCategoria' => $categoria->Categoria]) }}">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            ...
                            <li>Email: spotfinder@doctum.com</li>
                        </ul>
                    </div>
                </div>
                    ...
                    <div class="footer__copyright">
                        <div class="footer__copyright__text">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                ...
                                template is made with <i class="fa fa-heart" aria-hidden="true"> Ryan</i>
